...
DefaultProperties
{
	//gongji01(1)
	//	gongji03
	AnimCfg_Animation=(AnimationNames=("zhujue_gongji_futou01"),BlendInTime=0.15,BlendOutTime=0.15,PlayRate=1.000000,bCauseActorAnimEnd=True,RootBoneTransitionOption[0]=RBA_Translate,RootBoneTransitionOption[2]=RBA_Translate,FakeRootMotionMode=RMM_Accel)
