...
DefaultProperties
{
	...
	AnimCfg_GetUp=(AnimationNames=("zombie-creepingup"),PlayRate=1.000000,bCauseActorAnimEnd=True,bTriggerFakeRootMotion=True,FakeRootMotionMode=RMM_Accel,bLoop=false,blendouttime=0.15)
